...
export const translations = {
  ja: {
    ...
    playerOne: "1P側",
    playerTwo: "2P側",
    sideUnknown: "1P・2P情報なし（次回の再取得で更新されます）",
    playerOneWinRate: "1P勝率",
    playerTwoWinRate: "2P勝率",
    sideRecord: "{wins}勝 / {matches}戦",
    wins: "勝利",
    losses: "敗北",
    undecided: "判定不能",
  ...
  en: {
    ...
    reset: "Reset",
    winRate: "Win rate",
    playerOne: "Player 1 side",
    playerTwo: "Player 2 side",
    sideUnknown: "Side unavailable (updated when this match is fetched again)",
    playerOneWinRate: "P1 win rate",
    playerTwoWinRate: "P2 win rate",
    sideRecord: "{wins}W / {matches} matches",
    wins: "Wins",
    losses: "Losses",
    undecided: "Undecided",
    dailyTrend: "DAILY TREND",
